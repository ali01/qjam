...
of use. As a general-purpose programming language, python is much better suited
to implement systems than either Matlab or R, making communication between
multiple processes simple. Python is highly portable, and, unlike both R and
Matlab, most popular OS distributions come with the interpreter pre installed.
Python is also free.
