...
\begin{figure}[h!]
  \begin{center}
    \includegraphics[width=3.3in]{graphs/iteration_mean_time_speedup.pdf}
  \end{center}
  \label{graph_iteration_mean_time_speedup}
\end{figure}
...
\begin{figure}[h!]
  \begin{center}
    \includegraphics[width=3.3in]{graphs/total_running_time_speedup.pdf}
  \end{center}
