...
a task. It contains an encoded\footnote{base64 representation of the serialized
  Python object} representation of the client's code module, a hash of the
chunks that compose the worker's assigned dataset, and an encoded
representation of the client-specified parameters.
...
TODO: run benchmarks with longer running times / larger number of patches
